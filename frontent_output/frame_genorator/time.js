...
exports.delay_block_block = (block, previousFrame) => {
    ...
    const frame = new arduino_frame_1.ArduinoFrame(block.id, copyFrame.variables, copyFrame.components, timeCommand);
    return [frame];
};
