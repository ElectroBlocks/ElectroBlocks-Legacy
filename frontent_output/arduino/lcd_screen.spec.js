...
describe('LCD Screen', () => {
    it('should print all the the number of rows in the lcd screen', () => {
        ...
        expect(lcd.simplePrint(['Hello', 'World', 'PEOPLE']).type).toBe(command_1.COMMAND_TYPE.USB);
    });
    it('should print strings with spaces', () => {
        ...
        expect(lcd.simplePrint(['  Hello  ', '  World  ', '   sdafsd  asdf', ' asdf ']).type).toBe(command_1.COMMAND_TYPE.USB);
    });
    it('if all the rows are not given it should print a blank row', () => {
        ...
        expect(lcd.simplePrint(['1 ', 'Blue']).type).toBe(command_1.COMMAND_TYPE.USB);
    });
