...
class Pin {
    ...
    usbCommand() {
        ...
        return {
            command: `${usb_1.USB_COMMAND_TYPES.MOVE}-${usb_1.USB_COMMAND_TYPES.PIN}-${this.type}:${this.pinNumber}:${pinState}${usb_1.USB_COMMAND_TYPES.END_OF_COMMAND}`,
...
;
exports.stringToPin = (pin) => {
    const pinKey = "PIN_" + pin.toString();
    return ARDUINO_UNO_PINS[pinKey];
};
