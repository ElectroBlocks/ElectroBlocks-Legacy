...
export const changeLoopNumberInSensorBlocks = (workspace: Blockly.Workspace, event: Object) => {
    ...
    const arduinoStart =  Blockly.getMainWorkspace().getBlockById(event['blockId']);
