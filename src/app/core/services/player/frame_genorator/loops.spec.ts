...
describe('loops', () => {
  ...
  describe('controls_repeat_ext_block', () => {
    it('should generate x number from frames', () => {
      getInputValueSpy
        .withArgs(block, 'TIMES', 1, frameLocation, undefined)
        .and.returnValue(2);
      ...
      const frames = controls_repeat_ext_block(
        block,
        frameLocation
      ) as ArduinoFrame[];
  ...
  describe('controls_for_block', () => {
    it('should be able to to go forwards', () => {
      getInputValueSpy
        .withArgs(block, 'FROM', 1, frameLocation, undefined)
        .and.returnValue(1);

      getInputValueSpy
        .withArgs(block, 'TO', 1, frameLocation, undefined)
        .and.returnValue(3);

      getInputValueSpy
        .withArgs(block, 'BY', 1, frameLocation, undefined)
        .and.returnValue(1);
