...
export const mapFakeSensorValuesToBlocks: {
         ...
         push_button_setup_block: {
           ...
           convertToState(
             ...
             const pin =
               stringToPin(setupBlock.getFieldValue('PIN')) ||
               ARDUINO_UNO_PINS.PIN_7;
         ...
         message_setup_block: {
           ...
           convertToState(
             ...
             return new ArduinoMessageState(
               data.receiving_message,
               data.message
             );
           }
         ...
         rfid_setup_block: {
           ...
           convertToState(
             ...
             const rxPin =
               stringToPin(setupBlock.getFieldValue('RX')) ||
               ARDUINO_UNO_PINS.PIN_7;
             const txPin =
               stringToPin(setupBlock.getFieldValue('TX')) ||
