...
import {
	variables_get_colour_block, variables_get_number_block, variables_get_string_block,
...
describe('Variables Frame Generators', () => {
	...
	it('get the color variable from the previous frame', () => {
		...
		expect(variables_get_colour_block(block, previousFrame)).toEqual({red: 30, green: 30, blue: 20});
	...
	it('get the string variable from the previous frame', () => {
		...
		expect(variables_get_string_block(block, previousFrame)).toBe('Hello World');
