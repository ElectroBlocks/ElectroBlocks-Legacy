...
export const colour_picker_block = (block: Block,frameLocation: FrameLocation, previousFrame?: ArduinoFrame) : Color => {
 ...
 *
 */
export const colour_random_block = (block: Block,frameLocation: FrameLocation, previousFrame?: ArduinoFrame): Color =>  {
 ...
 *
 */
export const colour_rgb_block = (block: Block, frameLocation: FrameLocation, previousFrame?: ArduinoFrame) : Color =>  {
