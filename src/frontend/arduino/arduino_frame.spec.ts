...
describe('Arduino Frame', () => {
    ...
    let variables = {};
    let simpleFrame = new ArduinoFrame('23423', variables, [pin, servo], servo.usbCommand());
    let complexFrame = new ArduinoFrame('23423', variables, [lcdscreen,pin, servo], lcdscreen.usbCommand());
