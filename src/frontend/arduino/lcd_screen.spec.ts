...
describe('LCD Screen', () => {
    ...
    it ('should print all the the number of rows in the lcd screen', () => {
        ...
        expect(lcd.print(['Hello', 'World', 'PEOPLE']).type).toBe(COMMAND_TYPE.USB);
    ...
    it('should print strings with spaces', () => {
        ...
        expect(lcd.print(['  Hello  ', '  World  ', '   sdafsd  asdf', ' asdf ']).type).toBe(COMMAND_TYPE.USB);
    });
    ...
    it('if all the rows are not given it should print a blank row', () => {
        ...
        expect(lcd.print(['1 ', 'Blue']).type).toBe(COMMAND_TYPE.USB);
